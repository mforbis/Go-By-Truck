...
ORANGE2 = {233/255,78/255,27/255,.8}
ORANGE_OVER = {255/255,145/255,109/255}
WHITE = {1,1,1}
BLACK = {0,0,0}
RED = {1,0,0}
GREY_BUTTON = {255,255,255,.4}
GREY_BUTTON_BORDER = {192/255,192/255,192/255}
...
INPUT_FIELD_BG_COLOR = {0/255,0/255,0/255,.7}
INPUT_FIELD_BORDER_COLOR = {.5,.5,.5}
INPUT_FIELD_BORDER_WIDTH = 1
INPUT_FIELD_TEXT_SIZE = 20
INPUT_FIELD_TEXT_COLOR = {255/255,255/255,255/255}
INPUT_ROUNDED_CORNER = 5
